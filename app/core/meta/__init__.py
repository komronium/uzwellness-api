...
META: dict[str, list[Option]] = {
    ...
    "stay_option_guest_types": _ROOM["stay_option_guest_types"],
    "room_offer_package_kinds": _ROOM["room_offer_package_kinds"],
    "room_guest_option_presets": _ROOM["room_guest_option_presets"],
