...
class ProgramService:
    ...
    async def create(
        ...
        program = TreatmentProgram(
            ...
            stay_package_kind=payload.stay_package_kind,
            guest_applicability=payload.guest_applicability,
            ...
            medical_exam_count=payload.medical_exam_count,
            medical_procedure_count=payload.medical_procedure_count,
            drink_cure_included=payload.drink_cure_included,
            sauna_entries=payload.sauna_entries,
            pool_access_included=payload.pool_access_included,
            included_services=payload.included_services,
            is_default_stay_package=payload.is_default_stay_package,
